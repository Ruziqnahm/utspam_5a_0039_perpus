...
class EditScreen extends StatefulWidget {
  ...
  const EditScreen({super.key, required this.user, required this.transaction});
...
class _EditScreenState extends State<EditScreen> {
  ...
  void initState() {
    super.initState();
    final parts = widget.transaction.startDate.split('/');
    _startDate = DateTime(
      int.parse(parts[2]),
      int.parse(parts[1]),
      int.parse(parts[0]),
    );
    _duration = widget.transaction.borrowDuration;
    _totalCost = widget.transaction.totalCost;
    _pricePerDay = widget.transaction.pricePerDay;
  ...
  void _calculateCost() {
    ...
    setState(() {
      _duration = duration;
      _totalCost = _pricePerDay * duration;
    });
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(title: const Text('Edit Transaction'), elevation: 0),
